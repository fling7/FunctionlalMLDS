...
| Entity.kind-Werte `asset`, `agent`, `stateObject` | seit v0.5 optionales Kernattribut `Entity.kind [0..1]` | Die grobe Typisierung ist nun explizit modellierbar; fehlende oder feinere Objekttypen bleiben bewusst ausserhalb des Kerns. | seit v0.5 direkt modellierbar | Keine weitere Kernklasse noetig; Interaktionsobjekt-Details bleiben ggf. Ergaenzungsmodell. |
