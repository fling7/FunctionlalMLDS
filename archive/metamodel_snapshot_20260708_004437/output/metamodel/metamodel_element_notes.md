...
| Element | Kurzbeschreibung | Wichtige Beziehungen und Regeln | Relevanz fuer die Beispiele |
| --- | --- | --- | --- |
| `Entity` | Fachlich relevante ausfuehrende oder beobachtete Entitaet, z. B. user, system, environment oder asset. | Kann Capabilities bereitstellen; `Agent` ist spezialisierte Entity. | Kandidat fuer Vivian, Agenten, Kaffeemaschine, Werkzeuge und Szenenobjekte. |
