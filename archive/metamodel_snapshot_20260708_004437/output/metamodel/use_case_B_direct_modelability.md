...
| Validierung | ja | `ValidationCase` kann Requirements, UseCase, Scenarios und RuntimeBindings pruefen. |
...
| Hauptpfadabschluss pruefen | `ValidationCase` | `ValidationCase.validates -> UseCase/Scenario [0..*]`; `expectedOutcome [1..*]` | `B-VC-006-MAIN-COMPLETION` |
