...
| --- | --- | --- | --- | --- |
| `ENT-B-01 VivianAssistant` | `Agent` und damit `Entity` | `system` | angelegt in Task 8.3 | Vivian-Modus, Vivian-Hinweise, Rueckfragen, Fehlererklaerung und Abschlussmeldung |
...
| `ENT-B-04 BrewingRequest` | `Entity` | `system` | minimale Kontext-Entity fuer StateAssertions | Startwunsch, Bestaetigung und fachlicher Startausloesungszustand |
