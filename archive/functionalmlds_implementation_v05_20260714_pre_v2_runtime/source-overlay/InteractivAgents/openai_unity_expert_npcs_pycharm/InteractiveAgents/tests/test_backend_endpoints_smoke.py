...
class BackendEndpointSmokeTest(unittest.TestCase):
    def test_legacy_and_functionalmlds_endpoints(self) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="functionalmlds_endpoint_smoke_") as tmp:
            ...
            with mock.patch("backend.state.FunctionalMldsAdapter.discover", side_effect=discover_for_test) as discover_mock:
                ...
                self.assertEqual("functionalmlds_trace_map", self._read_json(trace_map).get("schema"))
