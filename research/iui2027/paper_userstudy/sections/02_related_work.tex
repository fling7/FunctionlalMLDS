...
\subsection{Human--AI control, contracts, and provenance}
...
Explanations should answer questions people actually have
\cite{liao2020questioning}, but explanation alone does not guarantee improved
joint performance \cite{bansal2021whole}.  These findings motivate explicit
selection states and structured route evidence.  They do not justify a claim
that the current diagnostic payload is usable or beneficial; the evaluation
tests conformance to the declared behavior, not human outcomes.
