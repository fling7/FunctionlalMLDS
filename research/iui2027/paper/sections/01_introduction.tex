...
Imagine a visitor standing in a virtual classroom and asking an embodied agent,
``What can you tell me about this dinosaur?'' The visible object, the visitor's
position, the responsible agent, and the relevant knowledge are all part of the
...
\begin{enumerate}
  ...
  interfaces, implemented across Unity/WebXR and a conversational-agent backend;
