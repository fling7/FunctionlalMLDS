...
| Entity-Art und systemische Logik entschieden | `Entity.kind = asset`; systemische Logik wird nicht in die Entity verschoben, sondern spaeter als Capability modelliert. |
