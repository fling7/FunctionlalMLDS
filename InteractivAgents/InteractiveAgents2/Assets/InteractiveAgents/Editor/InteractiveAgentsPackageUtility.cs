...
public static class InteractiveAgentsPackageUtility
{
    ...
    private const string VersionPath = PackageRoot + "/InteractiveAgentsVersion.cs";
    ...
    private const string FunctionalMldsV2BridgePath = "Assets/Scripting/FunctionalMldsV2QuickAgentBridge.cs";
    private const string FunctionalMldsV2RuntimePath = "Assets/Scripting/FunctionalMldsV2";
    ...
    private static readonly string[] CorePackagePaths =
    {
        ...
        FunctionalMldsV2BridgePath,
        FunctionalMldsV2RuntimePath,
        ProjectManagerPath,
        ProjectWizardPath,
        BestfitMldsPath,
        KlassenraumMldsPath,
    ...
    private static readonly RecommendedPackage[] RecommendedPackages =
    {
        ...
        new RecommendedPackage("com.unity.nuget.newtonsoft-json", "Newtonsoft JSON", "Required by the native FunctionalMLDS V2 loader."),
